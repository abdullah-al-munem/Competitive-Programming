...
// As we know NP-complete problem has no polynomial solution
// So the time complexity of this (Hamiltonian path problem) is O(2^n * n^2)
...
void findHamiltonianPath(vector<int> graph[]){
